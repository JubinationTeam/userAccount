...
function validate(model){
    if(!model.req.body)
    {
        ...
        jubiForLoop(model,keys,(data,key)=>{console.log(data.params[key]+":::::::::::");globalEmitter.emit(data.params[key],data)},(data)=>{data.emit(nextCall,data)})
    }
    else{
